...
document.addEventListener("DOMContentLoaded", function() {
    ...
    frontViewBtn.addEventListener('click', function() {
        cameraImage.src = "images/gallery/DR_FV.jpg";
        toggleImage();
    });

    backViewBtn.addEventListener('click', function() {
        cameraImage.src = "images/gallery/DR_BK.jpg";
        toggleImage();
    });

    leftViewBtn.addEventListener('click', function() {
        cameraImage.src = "images/gallery/DR_LFT.jpg";
        toggleImage();
    });
	
	rightViewBtn.addEventListener('click', function() {
        cameraImage.src = "images/gallery/DR_RGT.jpg";
        toggleImage();
    });
	
	wireframeBtn.addEventListener('click', function() {
        cameraImage.src = "images/gallery/WF.jpg";
        toggleImage();
    });
