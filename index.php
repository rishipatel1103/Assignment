...
<?php
  ...
  echo '<div class="photo"><img src="Images/Gallery/coke_zero.jpg" alt="Coke Zero">
  ...
  echo '<div class="photo"><img src="Images/Gallery/DrPepper.jpg" alt="Dr Pepper">
  ...
  echo '<div class="photo"><img src="Images/Gallery/Schewepps.jpg" alt="Schweppes">
...
// Video section initially hidden
  ...
  echo '<source src="Images/coke0video.mp4" type="video/mp4">';
  echo '</video>';
  echo '</div>';
